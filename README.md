...
3. Install [**Portenta_H7_ISR_Servo** library](https://platformio.org/lib/show/xxxxx/Portenta_H7_ISR_Servo) by using [Library Manager](https://platformio.org/lib/show/xxxxx/Portenta_H7_ISR_Servo/installation). Search for **Portenta_H7_ISR_Servo** in [Platform.io Author's Libraries](https://platformio.org/lib/search?query=author:%22Khoi%20Hoang%22)
